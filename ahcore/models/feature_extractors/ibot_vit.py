"""
This module contains the base classes for feature extraction from the foundation model by Owkin.
ahcore adopts the original implementation as it is into the model zoo.

The original implementation can be found below:
https://github.com/owkin/HistoSSLscaling/blob/main/rl_benchmarks/models/feature_extractors/ibot_vit.py
"""
